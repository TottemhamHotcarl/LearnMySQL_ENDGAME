...
public class GroupUI  extends Panel implements View{
	...
	public void groupUIInit() {
		...
		content.removeAllComponents();
		 ...
		 if(t.queryOk) {
			...
			addMember.setDescription("This allows you to add members to your group");
			Button viewMembers = new Button("View Members");
			viewMembers.setDescription("View all the members of your group");
			l.addStyleName(ValoTheme.LABEL_COLORED);
		

			Button GroupQueryBox = new Button("Group Query Box");
			GroupQueryBox.setDescription("Takes you to your groups database");
	...
	public void addMember() {
		...
		// Find the application directory
					...
					TempBack.setStyleName(ValoTheme.BUTTON_LINK);
					TempBack.setIcon(resource); 
					
		 
		 
		 content.addComponents(TempBack,memberName, createMember);
