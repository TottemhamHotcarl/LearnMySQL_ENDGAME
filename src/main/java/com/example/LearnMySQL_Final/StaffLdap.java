...
public class StaffLdap {
	 private LdapContext context; 
	    ...
	    public static StaffLdap connect(String domain, String username, String password) {
	        return new StaffLdap(domain, username, password);
	    }

	    private StaffLdap(String domain, String username, String password) {
	    ...
	    public Person getUser(String username) {
	        ...
	        try {
	            ...
	            NamingEnumeration answer = context.search("ou=faculty of science,ou=wits university,dc=ds,dc=wits,dc=ac,dc=za", "uid="
